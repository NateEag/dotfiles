...
const workspaceContext = {
    resolveRelativePath: (relativePath, resource) => { return URL.resolve(resource, relativePath); }
};
/****************
 * Variables
 ****************/
...
connection.onNotification(requestTypes_1.DynamicCustomSchemaRequestRegistration.type, () => {
    const schemaProvider = (resource => { return connection.sendRequest(requestTypes_1.CustomSchemaRequest.type, resource); });
 ...
 */
connection.onCompletionResolve(completionItem => { return exports.customLanguageService.doResolve(completionItem); });
/**
