...
suite('Auto Completion Tests', () => {
    ...
    function parseSetup(content, position) {
        ...
        const yDoc = yamlParser07_1.parse(testTextDocument.getText());
...
function completionHelper(document, textDocumentPosition) {
    ...
    if (textLine.indexOf(':') === -1) {
        ...
        const jsonDocument = yamlParser07_1.parse(newText);
        return languageService.doComplete(document, position, false);
    }
    else {
        //All the nodes are loaded
        position.character = position.character - 1;
        const jsonDocument = yamlParser07_1.parse(document.getText());
        return languageService.doComplete(document, position, false);
    }
}
