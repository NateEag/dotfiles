...
var IEVM, Q, child_process, debug, fs, https, path, url,
...
IEVM = (function() {
  ...
  IEVM.versions = ['6', '7', '8', '9', '10', '11', 'EDGE'];

  IEVM.oses = ['WinXP', 'Vista', 'Win7', 'Win8', 'Win10'];

  IEVM.names = ['IE6 - WinXP', 'IE7 - WinXP', 'IE8 - WinXP', 'IE7 - Vista', 'IE8 - Win7', 'IE9 - Win7', 'IE10 - Win7', 'IE10 - Win8', 'IE11 - Win7', 'MSEdge - Win10'];
  ...
  IEVM.prototype.url = function() {
    if (this.version === 'EDGE') {
      return 'https://az792536.vo.msecnd.net/vms/VMBuild_20160802/VirtualBox/' + 'MSEdge/MSEdge.Win10_RS1.VirtualBox.zip';
    }
    return 'https://az412801.vo.msecnd.net/vhd/IEKitV1_Final/VirtualBox/OSX/' + this.archive();
  };
